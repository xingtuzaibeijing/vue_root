    ...
    S.prototype.config = {
        ...
        if (a.startTime = (new Date).getTime(), n.url) {
            ...
            c[o.pageName] = e, c[o.limitName] = n.limit, t.ajax({
                ...
                dataType: "json",
                success: function (t) {
                    t[r.statusName] != r.statusCode ? (a.renderForm(), a.layMain.html('<div class="' + f + '">' + (t[r.msgName] || "返回的数据状态异常") + "</div>")) : (a.renderData(t, e, t.data[r.countName]), d(), n.time = (new Date).getTime() - a.startTime + " ms"), i && l.close(i), "function" == typeof n.done && n.done(t, e, t.data[r.countName])
                },
                error: function (e, t) {
        ...
        var c = this, s = c.config;
        var e_data;
        if(e.data[s.response.dataName]!=undefined){
            e_data=e.data;
        }else{
            e_data=e;
        }
        var  u = e_data[s.response.dataName] || [], y = [], p = [], m = [], v = function () {
